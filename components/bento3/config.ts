export const cfg = [
  ...
  { id: '3', x: 2, y: 5, width: 1, height: 2, component: markRaw(createBentoCellComponent('Bento3', '3')) },
  { id: '4', x: 3, y: 5, width: 2, height: 2, component: markRaw(createBentoCellComponent('Bento4', '4')) },
